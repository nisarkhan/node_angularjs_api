...
$.extend( true, DataTable.defaults, {
  dom:
    "<'row form-inline'<'col-xs-5'l><'col-xs-7'f>>"+
    "<'row relative'rt>"+
...
DataTable.ext.renderer.header.bootstrap = function(settings){
  ...
  var menu = {
    elem : $('<span/>', { 'class' : 'btn-group' }),
    label: $('<button/>', { type: 'button', 'class': 'btn btn-white', 'data-toggle': 'dropdown' }),
    caret: $('<button/>', { type: 'button', 'class': 'btn btn-white dropdown-toggle', 'data-toggle': 'dropdown' }),
    ul: $('<ul/>', { role: 'menu', class : 'dropdown-menu fx-slidedown' })
  };
  ...
  $('option', length).each( function(){
    ...
    var option = this,
        ...
        icon = $('<i/>',{ 'class': 'fa fa-check-circle pull-right text-green'});
